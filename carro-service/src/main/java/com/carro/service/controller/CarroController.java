...
public class CarroController {
	...
	public ResponseEntity<Carro> guardarUsuario(@RequestBody Carro carro){
		Carro nueoCarro = carroService.save(carro);
		return ResponseEntity.ok(nueoCarro);
	}
	
	@GetMapping("/usuario/{usuarioid}")
	public ResponseEntity<List<Carro>> obtenerCarroxUsuario(@PathVariable("usuarioid") int id){
